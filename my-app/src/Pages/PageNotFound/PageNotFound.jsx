...
export const PageNotFound = () => {
    ...
    return (
        <div className="page-notfound">
                <svg className="sgv-notfound" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                    viewBox="0 0 800 600">
                    <g>
                        <defs>
                ...
                <div className="info-notfound">
                    ...
                    <button className="btn-notfound green"><Link to="/#">HOME</Link></button>
                </div>
            </div>
    );
}
